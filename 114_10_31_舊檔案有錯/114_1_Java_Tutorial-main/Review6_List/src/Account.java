...
public class Account {
    ...
    public Account(String accountNumber, double initialBalance) {
        this(accountNumber, ownerName:"未知", ownerID:000000,initialBalance);
    }
    ...
    public Account(String accountNumber) {
        this(accountNumber, ownerName:"未知",ownerID:000000, 0);
    }
    ...
    {
        return String.format("帳戶號碼:%s,持有人:%s,餘額:%.開立日期:%s,開立時間:%s",
                accountNumber,owner,balance,openingTime.toString());
